...
func genGeneratedHeader(gen *protogen.Plugin, g *protogen.GeneratedFile, f *fileInfo) {
	g.P("// Code generated by protoc-gen-hip. DO NOT EDIT.")
	...
	if GenerateVersionMarkers {
		...
		g.P("// \tprotoc-gen-hip ", protocGenGoVersion)
...
func genXService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service, omitempty bool) {
	...
	for _, value := range service.Methods {
		...
		g.P("type result struct {")
		g.P("Code   int32       `json:\"code\"`")
		g.P("Detail string      `json:\"detail\"`")
		g.P("Status int         `json:\"status\"`")
		g.P("Data   proto.Message `json:\"data\"`")
		g.P("}")
		g.P("rt:= result{}")
		g.P("  if ok := ctx.Bind(req); ok != nil {")
		g.P("rt.Code=10000")
		g.P(`rt.Detail = "bind request error"`)
		g.P("rt.Status = 200 ")
